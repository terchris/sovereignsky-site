...
{{< datacenter-map providers="skygard" showFilters="false" >}}
...
<div class="ss-dc-country-group not-prose">
  ...
  data-country-id="NO"
  data-search="norway no oslo (hovinbyen) no-oslo-hovinbyen oslo">
  <span class="font-medium">Oslo (Hovinbyen)</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Oslo <span class="text-neutral-400 dark:text-neutral-500">(no-oslo-hovinbyen)</span></span>
</span>
    </div>
  </details>
</div>
