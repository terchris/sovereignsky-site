...
{{< datacenter-map providers="telia" showFilters="false" >}}
...
<div class="ss-dc-country-group not-prose">
  ...
  data-country-id="FI"
  data-search="finland fi helsinki (lauttasaari) hel-lauttasaari helsinki">
  <span class="font-medium">Helsinki (Lauttasaari)</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Helsinki <span class="text-neutral-400 dark:text-neutral-500">(hel-lauttasaari)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="FI"
  data-search="finland fi helsinki (pitäjänmäki) hel-pitajanmaki helsinki">
  <span class="font-medium">Helsinki (Pitäjänmäki)</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Helsinki <span class="text-neutral-400 dark:text-neutral-500">(hel-pitajanmaki)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="FI"
  data-search="finland fi lahti lahti lahti">
  <span class="font-medium">Lahti</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Lahti <span class="text-neutral-400 dark:text-neutral-500">(lahti)</span></span>
</span>
    </div>
  </details>
</div>
