...
{{< datacenter-map providers="plusserver" showFilters="false" >}}
...
<div class="ss-dc-country-group not-prose">
  ...
  data-country-id="DE"
  data-search="germany de cologne cgn3 cologne">
  <span class="font-medium">Cologne</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Cologne <span class="text-neutral-400 dark:text-neutral-500">(cgn3)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="DE"
  data-search="germany de düsseldorf dus6 düsseldorf">
  <span class="font-medium">Düsseldorf</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Düsseldorf <span class="text-neutral-400 dark:text-neutral-500">(dus6)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="DE"
  data-search="germany de hamburg 1 ham1 hamburg">
  <span class="font-medium">Hamburg 1</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Hamburg <span class="text-neutral-400 dark:text-neutral-500">(ham1)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="DE"
  data-search="germany de hamburg 2 ham2 hamburg">
  <span class="font-medium">Hamburg 2</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Hamburg <span class="text-neutral-400 dark:text-neutral-500">(ham2)</span></span>
</span>
    </div>
  </details>
</div>
