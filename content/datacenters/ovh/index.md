...
{{< datacenter-map providers="ovh" showFilters="false" >}}
...
<div class="ss-dc-country-group not-prose">
  <details class="mt-3">
    <summary class="cursor-pointer font-semibold text-neutral-800 dark:text-neutral-100">🇫🇷 France (FR) — 3</summary>
  ...
  data-country-id="FR"
  data-search="france fr gravelines gra gravelines">
  <span class="font-medium">Gravelines</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Gravelines <span class="text-neutral-400 dark:text-neutral-500">(gra)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="FR"
  data-search="france fr roubaix rbx roubaix">
  <span class="font-medium">Roubaix</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Roubaix <span class="text-neutral-400 dark:text-neutral-500">(rbx)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="FR"
  data-search="france fr strasbourg sbg strasbourg">
  <span class="font-medium">Strasbourg</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Strasbourg <span class="text-neutral-400 dark:text-neutral-500">(sbg)</span></span>
</span>
    </div>
  </details>
</div>
...
<div class="ss-dc-country-group not-prose">
  <details class="mt-3">
    ...
    <div class="mt-2 flex flex-wrap gap-2">
      <span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="DE"
  data-search="germany de frankfurt fra frankfurt">
  <span class="font-medium">Frankfurt</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Frankfurt <span class="text-neutral-400 dark:text-neutral-500">(fra)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="DE"
  data-search="germany de limburg lim limburg">
  <span class="font-medium">Limburg</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Limburg <span class="text-neutral-400 dark:text-neutral-500">(lim)</span></span>
</span>
    </div>
  </details>
</div>
...
<div class="ss-dc-country-group not-prose">
  <details class="mt-3">
    ...
    <div class="mt-2 flex flex-wrap gap-2">
      <span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="AU"
  data-search="australia au sydney syd sydney">
  <span class="font-medium">Sydney</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Sydney <span class="text-neutral-400 dark:text-neutral-500">(syd)</span></span>
</span>
    </div>
  </details>
</div>
...
<div class="ss-dc-country-group not-prose">
  <details class="mt-3">
    <summary class="cursor-pointer font-semibold text-neutral-800 dark:text-neutral-100">🇨🇦 Canada (CA) — 1</summary>
    <div class="mt-2 flex flex-wrap gap-2">
      <span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="CA"
  data-search="canada ca beauharnois bhs beauharnois">
  <span class="font-medium">Beauharnois</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Beauharnois <span class="text-neutral-400 dark:text-neutral-500">(bhs)</span></span>
</span>
    </div>
  </details>
</div>
...
<div class="ss-dc-country-group not-prose">
  <details class="mt-3">
    ...
    <div class="mt-2 flex flex-wrap gap-2">
      <span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="PL"
  data-search="poland pl warsaw waw warsaw">
  <span class="font-medium">Warsaw</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Warsaw <span class="text-neutral-400 dark:text-neutral-500">(waw)</span></span>
</span>
    </div>
  </details>
</div>
...
<div class="ss-dc-country-group not-prose">
  <details class="mt-3">
    ...
    <div class="mt-2 flex flex-wrap gap-2">
      <span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="SG"
  data-search="singapore sg singapore sgp singapore">
  <span class="font-medium">Singapore</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Singapore <span class="text-neutral-400 dark:text-neutral-500">(sgp)</span></span>
</span>
    </div>
  </details>
</div>
...
<div class="ss-dc-country-group not-prose">
  <details class="mt-3">
    ...
    <div class="mt-2 flex flex-wrap gap-2">
      <span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="GB"
  data-search="united kingdom gb london lon london">
  <span class="font-medium">London</span>
  <span class="text-neutral-500 dark:text-neutral-400">— London <span class="text-neutral-400 dark:text-neutral-500">(lon)</span></span>
</span>
    </div>
  </details>
</div>
