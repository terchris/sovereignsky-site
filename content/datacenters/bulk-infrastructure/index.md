...
{{< datacenter-map providers="bulk-infrastructure" showFilters="false" >}}
...
<div class="ss-dc-country-group not-prose">
  ...
  data-country-id="NO"
  data-search="norway no n01 data center campus n01 kristiansand">
  <span class="font-medium">N01 Data Center Campus</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Kristiansand <span class="text-neutral-400 dark:text-neutral-500">(N01)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="NO"
  data-search="norway no oslo internet exchange (os-ix) os-ix oslo">
  <span class="font-medium">Oslo Internet Exchange (OS-IX)</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Oslo <span class="text-neutral-400 dark:text-neutral-500">(OS-IX)</span></span>
</span>
    </div>
  </details>
</div>
