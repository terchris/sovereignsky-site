...
{{< datacenter-map providers="leaseweb" showFilters="false" >}}
...
<div class="ss-dc-country-group not-prose">
  <details class="mt-3">
    <summary class="cursor-pointer font-semibold text-neutral-800 dark:text-neutral-100">🇩🇪 Germany (DE) — 3</summary>
  ...
  data-country-id="DE"
  data-search="germany de frankfurt fra-01 fra-01 frankfurt">
  <span class="font-medium">Frankfurt FRA-01</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Frankfurt <span class="text-neutral-400 dark:text-neutral-500">(fra-01)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="DE"
  data-search="germany de frankfurt fra-10 fra-10 frankfurt">
  <span class="font-medium">Frankfurt FRA-10</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Frankfurt <span class="text-neutral-400 dark:text-neutral-500">(fra-10)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="DE"
  data-search="germany de frankfurt fra-14 fra-14 frankfurt">
  <span class="font-medium">Frankfurt FRA-14</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Frankfurt <span class="text-neutral-400 dark:text-neutral-500">(fra-14)</span></span>
</span>
    </div>
  </details>
</div>
...
<div class="ss-dc-country-group not-prose">
  <details class="mt-3">
    ...
    <div class="mt-2 flex flex-wrap gap-2">
      <span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="NL"
  data-search="netherlands nl amsterdam ams-01 ams-01 amsterdam">
  <span class="font-medium">Amsterdam AMS-01</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Amsterdam <span class="text-neutral-400 dark:text-neutral-500">(ams-01)</span></span>
</span>
    </div>
  </details>
</div>
