...
{{< datacenter-map providers="gridscale" showFilters="false" >}}
...
<div class="ss-dc-country-group not-prose">
  <details class="mt-3">
    <summary class="cursor-pointer font-semibold text-neutral-800 dark:text-neutral-100">🇩🇪 Germany (DE) — 5</summary>
  ...
  data-country-id="DE"
  data-search="germany de eichenzell de-ehz1 eichenzell">
  <span class="font-medium">Eichenzell</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Eichenzell <span class="text-neutral-400 dark:text-neutral-500">(de-ehz1)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="DE"
  data-search="germany de frankfurt 1 de-fra1 frankfurt">
...
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="DE"
  data-search="germany de frankfurt 2 de-fra2 frankfurt">
  <span class="font-medium">Frankfurt 2</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Frankfurt <span class="text-neutral-400 dark:text-neutral-500">(de-fra2)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="DE"
  data-search="germany de frankfurt 3 de-fra3 frankfurt">
  <span class="font-medium">Frankfurt 3</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Frankfurt <span class="text-neutral-400 dark:text-neutral-500">(de-fra3)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="DE"
  data-search="germany de hannover de-han1 hannover">
  <span class="font-medium">Hannover</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Hannover <span class="text-neutral-400 dark:text-neutral-500">(de-han1)</span></span>
</span>
    </div>
  </details>
</div>
