...
{{< datacenter-map providers="contabo" showFilters="false" >}}
...
<div class="ss-dc-country-group not-prose">
  ...
  data-country-id="US"
  data-search="usa us new york us-nyc new york">
  <span class="font-medium">New York</span>
  <span class="text-neutral-500 dark:text-neutral-400">— New York <span class="text-neutral-400 dark:text-neutral-500">(us-nyc)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="US"
  data-search="usa us seattle us-sea seattle">
  <span class="font-medium">Seattle</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Seattle <span class="text-neutral-400 dark:text-neutral-500">(us-sea)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="US"
  data-search="usa us st. louis us-stl st. louis">
  <span class="font-medium">St. Louis</span>
  <span class="text-neutral-500 dark:text-neutral-400">— St. Louis <span class="text-neutral-400 dark:text-neutral-500">(us-stl)</span></span>
</span>
    </div>
  </details>
</div>
...
<div class="ss-dc-country-group not-prose">
  <details class="mt-3">
    ...
    <div class="mt-2 flex flex-wrap gap-2">
      <span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="DE"
  data-search="germany de munich de-muc munich">
  <span class="font-medium">Munich</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Munich <span class="text-neutral-400 dark:text-neutral-500">(de-muc)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="DE"
  data-search="germany de nuremberg de-nue nuremberg">
  <span class="font-medium">Nuremberg</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Nuremberg <span class="text-neutral-400 dark:text-neutral-500">(de-nue)</span></span>
</span>
    </div>
  </details>
</div>
...
<div class="ss-dc-country-group not-prose">
  <details class="mt-3">
    ...
    <div class="mt-2 flex flex-wrap gap-2">
      <span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="SG"
  data-search="singapore sg singapore sg-sin singapore">
  <span class="font-medium">Singapore</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Singapore <span class="text-neutral-400 dark:text-neutral-500">(sg-sin)</span></span>
</span>
    </div>
  </details>
</div>
...
<div class="ss-dc-country-group not-prose">
  <details class="mt-3">
    ...
    <div class="mt-2 flex flex-wrap gap-2">
      <span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="GB"
  data-search="united kingdom gb portsmouth gb-por portsmouth">
  <span class="font-medium">Portsmouth</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Portsmouth <span class="text-neutral-400 dark:text-neutral-500">(gb-por)</span></span>
</span>
    </div>
  </details>
</div>
