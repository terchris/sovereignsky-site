...
{{< datacenter-map providers="verne" showFilters="false" >}}
...
<div class="ss-dc-country-group not-prose">
  ...
  data-country-id="FI"
  data-search="finland fi helsinki (the air) hel-air vantaa">
  <span class="font-medium">Helsinki (The Air)</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Vantaa <span class="text-neutral-400 dark:text-neutral-500">(hel-air)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="FI"
  data-search="finland fi pori (the rock) pori-rock pori">
  <span class="font-medium">Pori (The Rock)</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Pori <span class="text-neutral-400 dark:text-neutral-500">(pori-rock)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="FI"
  data-search="finland fi tampere (the deck) tre-deck tampere">
  <span class="font-medium">Tampere (The Deck)</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Tampere <span class="text-neutral-400 dark:text-neutral-500">(tre-deck)</span></span>
</span>
    </div>
  </details>
</div>
