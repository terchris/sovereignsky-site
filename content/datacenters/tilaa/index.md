...
{{< datacenter-map providers="tilaa" showFilters="false" >}}
...
<div class="ss-dc-country-group not-prose">
  <details class="mt-3">
    <summary class="cursor-pointer font-semibold text-neutral-800 dark:text-neutral-100">🇳🇱 Netherlands (NL) — 2</summary>
...
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="NL"
  data-search="netherlands nl haarlem nl-hrl haarlem">
  <span class="font-medium">Haarlem</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Haarlem <span class="text-neutral-400 dark:text-neutral-500">(nl-hrl)</span></span>
</span>
    </div>
  </details>
</div>
