...
{{< datacenter-map providers="infomaniak" showFilters="false" >}}
...
<div class="ss-dc-country-group not-prose">
  ...
  data-country-id="CH"
  data-search="switzerland ch geneva d2 gva-d2 geneva">
  <span class="font-medium">Geneva D2</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Geneva <span class="text-neutral-400 dark:text-neutral-500">(gva-d2)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="CH"
  data-search="switzerland ch geneva d3 gva-d3 geneva">
  <span class="font-medium">Geneva D3</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Geneva <span class="text-neutral-400 dark:text-neutral-500">(gva-d3)</span></span>
</span>
    </div>
  </details>
</div>
