...
{{< datacenter-map providers="cloudscale" showFilters="false" >}}
...
<div class="ss-dc-country-group not-prose">
  ...
  data-country-id="CH"
  data-search="switzerland ch lupfig lpg1 lupfig">
  <span class="font-medium">Lupfig</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Lupfig <span class="text-neutral-400 dark:text-neutral-500">(lpg1)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="CH"
  data-search="switzerland ch rümlang rma1 rümlang">
  <span class="font-medium">Rümlang</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Rümlang <span class="text-neutral-400 dark:text-neutral-500">(rma1)</span></span>
</span>
    </div>
  </details>
</div>
