...
{{< datacenter-map providers="digital-realty" showFilters="false" >}}
...
<div class="ss-dc-country-group not-prose">
  <details class="mt-3">
    <summary class="cursor-pointer font-semibold text-neutral-800 dark:text-neutral-100">🇩🇰 Denmark (DK) — 3</summary>
  ...
  data-country-id="DK"
  data-search="denmark dk copenhagen cph1 cph1 ballerup">
  <span class="font-medium">Copenhagen CPH1</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Ballerup <span class="text-neutral-400 dark:text-neutral-500">(cph1)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="DK"
  data-search="denmark dk copenhagen cph2 cph2 ballerup">
  <span class="font-medium">Copenhagen CPH2</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Ballerup <span class="text-neutral-400 dark:text-neutral-500">(cph2)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="DK"
  data-search="denmark dk copenhagen cph3 cph3 ballerup">
  <span class="font-medium">Copenhagen CPH3</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Ballerup <span class="text-neutral-400 dark:text-neutral-500">(cph3)</span></span>
</span>
    </div>
  </details>
</div>
