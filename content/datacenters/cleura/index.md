...
{{< datacenter-map providers="cleura" showFilters="false" >}}
...
<div class="ss-dc-country-group not-prose">
  ...
  data-country-id="SE"
  data-search="sweden se karlskrona kna1 karlskrona">
  <span class="font-medium">Karlskrona</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Karlskrona <span class="text-neutral-400 dark:text-neutral-500">(kna1)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="SE"
