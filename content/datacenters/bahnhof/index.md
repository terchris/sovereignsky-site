...
{{< datacenter-map providers="bahnhof" showFilters="false" >}}
...
<div class="ss-dc-country-group not-prose">
  <details class="mt-3">
    <summary class="cursor-pointer font-semibold text-neutral-800 dark:text-neutral-100">🇸🇪 Sweden (SE) — 4</summary>
  ...
  data-country-id="SE"
  data-search="sweden se pionen (stockholm) pionen stockholm">
  <span class="font-medium">Pionen (Stockholm)</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Stockholm <span class="text-neutral-400 dark:text-neutral-500">(pionen)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="SE"
  data-search="sweden se s:t eriks (stockholm) steriks stockholm">
  <span class="font-medium">S:t Eriks (Stockholm)</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Stockholm <span class="text-neutral-400 dark:text-neutral-500">(steriks)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="SE"
  data-search="sweden se sparven (malmö) sparven malmö">
  <span class="font-medium">Sparven (Malmö)</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Malmö <span class="text-neutral-400 dark:text-neutral-500">(sparven)</span></span>
</span>
<span class="ss-dc-region-chip inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
  data-country-id="SE"
  data-search="sweden se thule (stockholm) thule stockholm">
  <span class="font-medium">Thule (Stockholm)</span>
  <span class="text-neutral-500 dark:text-neutral-400">— Stockholm <span class="text-neutral-400 dark:text-neutral-500">(thule)</span></span>
</span>
    </div>
  </details>
</div>
